(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,7089,e=>{"use strict";var t=e.i(43476),a=e.i(46932);let i={sm:"text-xs px-4 py-2 rounded-full",md:"text-sm px-6 py-2.5 rounded-full",lg:"text-base px-8 py-3.5 rounded-full"},n={primary:"text-[#174A67] bg-white border-2 border-transparent bg-clip-padding shadow-[0_2px_8px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.12)]",secondary:"text-[#174A67] bg-white border-2 border-transparent bg-clip-padding shadow-[0_2px_8px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.12)]",outline:"text-[#174A67] bg-white border-2 border-transparent bg-clip-padding shadow-[0_2px_8px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.12)]",dark:"text-gray-900 bg-white border-2 border-transparent bg-clip-padding shadow-[0_2px_8px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.12)]"};function r(e){let{children:r,variant:s="dark",size:o="md",fullWidth:l,leftIcon:c,rightIcon:d,className:m="",as:u="button",...p}=e,g="dark"===s?"text-gray-900":"text-[#174A67]",h=`relative inline-flex items-center justify-center select-none no-underline font-semibold tracking-tight ${i[o]} ${n[s]} ${l?"w-full":""} transition-all duration-300 ease-out group focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue/50 disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100 overflow-hidden`,f=(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("span",{"aria-hidden":!0,className:"absolute inset-0 rounded-full bg-gradient-to-r from-[#7DD3FC] via-[#45C0B0] to-[#3B82F6] opacity-100 -z-10"}),(0,t.jsx)("span",{"aria-hidden":!0,className:"absolute inset-[2px] rounded-full bg-white -z-[1]"}),(0,t.jsxs)("span",{className:"relative flex items-center gap-2 relative z-10",children:[c&&(0,t.jsx)("span",{className:`flex items-center -ml-0.5 pro-btn-icon-left ${g}`,children:c}),(0,t.jsx)("span",{className:`pro-btn-text ${g} font-semibold`,children:r}),d&&(0,t.jsx)("span",{className:`flex items-center -mr-0.5 pro-btn-icon-right ${g}`,children:d})]})]}),y={whileHover:{scale:1.02,y:-2,transition:{type:"spring",stiffness:500,damping:30,mass:.5}},whileTap:{scale:.98,y:0,transition:{type:"spring",stiffness:600,damping:35,mass:.4}},initial:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.2,ease:[.25,.1,.25,1]}};if("a"===u){let{href:e,onDrag:i,onDragStart:n,onDragEnd:r,onAnimationStart:s,onAnimationEnd:o,...l}=p;return(0,t.jsx)(a.motion.a,{...y,...l,href:e,className:`${h} ${m}`,children:f})}let{onDrag:v,onDragStart:b,onDragEnd:w,onAnimationStart:x,onAnimationEnd:A,...k}=p;return(0,t.jsx)(a.motion.button,{...y,...k,className:`${h} ${m}`,children:f})}e.s(["default",()=>r])},71689,19418,e=>{"use strict";let t=(0,e.i(75254).default)("arrow-left",[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]]);function a(e,t){let a=e.replace(/\D/g,""),i=encodeURIComponent(t).replace(/'/g,"%27").replace(/\(/g,"%28").replace(/\)/g,"%29");return`https://wa.me/${a}?text=${i}`}e.s(["ArrowLeft",()=>t],71689),e.s(["WHATSAPP_PHONE",0,"971525010132","generateWhatsAppUrl",()=>a],19418)},3116,e=>{"use strict";let t=(0,e.i(75254).default)("clock",[["path",{d:"M12 6v6l4 2",key:"mmk7yg"}],["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}]]);e.s(["Clock",()=>t],3116)},87316,84614,36468,45574,e=>{"use strict";var t=e.i(75254);let a=(0,t.default)("calendar",[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}]]);e.s(["Calendar",()=>a],87316);let i=(0,t.default)("user",[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]]);e.s(["User",()=>i],84614);var n=e.i(71645);let r=[{id:1,slug:"elevating-spaces-with-excellence-aqsatech",title:"Elevating Spaces with Excellence – AQSATECH Contracting & Maintenance Services",excerpt:"At AQSATECH, we believe that every space has the potential to inspire comfort, functionality, and elegance. Discover our comprehensive range of services.",content:`At AQSATECH, we believe that every space has the potential to inspire comfort, functionality, and elegance. With years of experience in the contracting and maintenance industry, we have built a reputation for delivering high-quality solutions tailored to our clients' needs. From stylish interiors to reliable technical installations, our expertise covers a wide spectrum of services that make us a one-stop solution for both residential and commercial projects.
...
Visit us at aqsatech.ae or contact us today to discuss your project. Together, let's bring your vision to life with precision and excellence.`,image:"/Services Stock images/Property Management.png",category:"Company",author:"Aqsa Tech Team",date:"2025-11-10",readTime:"8 min read"},{id:2,slug:"top-10-home-maintenance-tips-uae",title:"Top 10 Home Maintenance Tips for UAE Residents",excerpt:"Keep your UAE home in perfect condition year-round with these essential maintenance tips from our expert team.",content:`Living in United Arab Emirates presents unique challenges for homeowners. The extreme heat, high humidity, and occasional sandstorms require proactive maintenance to keep your property in top condition. Here are the top 10 maintenance tips every UAE resident should follow.
...
Contact us today for a free consultation and customized maintenance plan for your property.`,image:"/Services Stock images/Renovation & Remodeling.png",category:"Home Maintenance",author:"Aqsa Tech Team",date:"2025-11-08",readTime:"8 min read"},{id:3,slug:"ac-maintenance-summer-guide",title:"AC Maintenance: Your Complete Summer Guide",excerpt:"Beat the UAE heat with our comprehensive AC maintenance checklist and professional tips.",content:`In United Arab Emirates, where summer temperatures regularly exceed 45\xb0C, your air conditioning system isn't just a luxury—it's a necessity. Proper AC maintenance ensures comfort, efficiency, and longevity while preventing costly breakdowns during the hottest months. Here's your complete guide to summer AC maintenance.
...
Smart Thermostat Use: Set your thermostat to 24-25\xb0C for optimal comfort and efficiency. Every degree lower increases energy consumption by approximately 8%. Use programmable or smart thermostats to adjust temperatures when you're away.
...
Setting Extremely Low Temperatures: Your AC works at maximum capacity regardless of setpoint. Setting it to 16\xb0C doesn't cool faster—it just wastes energy.
...
Don't wait for your AC to fail during peak summer. Contact us today to schedule your pre-summer maintenance and ensure cool comfort all season long.`,image:"/Services Stock images/HVAC & AC Service.png",category:"HVAC",author:"Ahmed Al-Mansouri",date:"2025-11-05",readTime:"10 min read"},{id:4,slug:"kitchen-renovation-trends-2025",title:"Kitchen Renovation Trends 2025: What's Hot in UAE",excerpt:"Discover the latest kitchen design trends transforming UAE homes this year.",content:`The kitchen has evolved from a purely functional space to the heart of the modern UAE home. As we move through 2025, innovative designs, smart technology, and sustainable materials are reshaping how we think about kitchen renovations. Here are the hottest trends transforming kitchens across the UAE.
...
Whether you're planning a complete renovation or strategic updates, we're here to help. Contact Aqsa Tech today for a free consultation and let's create the kitchen of your dreams—functional, beautiful, and perfectly suited to modern UAE living.`,image:"/Services Stock images/Kitchen Renovation.png",category:"Renovation",author:"Sara Khan",date:"2025-11-01",readTime:"12 min read"},{id:5,slug:"plumbing-emergencies-what-to-do",title:"Plumbing Emergencies: What to Do Before Help Arrives",excerpt:"Quick action can prevent water damage. Learn the essential first steps for common plumbing emergencies.",content:`Plumbing emergencies strike without warning and can cause thousands of dirhams in water damage within minutes. While professional help is essential, knowing what to do immediately can minimize damage, protect your property, and potentially save your belongings. Here's your comprehensive emergency response guide.
...
Remember: Your quick, informed response can mean the difference between minor inconvenience and major property damage. Stay calm, act decisively, and call professionals immediately.`,image:"/Services Stock images/Plumbing & sanitary contracting.png",category:"Plumbing",author:"Omar Hassan",date:"2025-10-28",readTime:"11 min read"},{id:6,slug:"choosing-right-paint-uae-climate",title:"Choosing the Right Paint for UAE's Climate",excerpt:"Not all paints are created equal. Find out which finishes and formulas work best in the UAE.",content:`UAE's unique climate—extreme heat, intense UV radiation, high humidity, and occasional sandstorms—demands careful paint selection. The wrong choice leads to premature fading, chalking, peeling, and frequent repainting. Understanding paint technology and climate-specific requirements ensures lasting beauty and protection. Here's your comprehensive guide to choosing the right paint for UAE conditions.
...
Temperature Extremes: Exterior surfaces can reach 70\xb0C in summer, while interiors face constant AC cooling. These fluctuations cause:
...
These advanced coatings reflect infrared radiation, reducing surface temperatures by 10-15\xb0C:
...
Contact Aqsa Tech today for a free consultation and quote. Let our experienced team help you select the perfect paint solution for your UAE property—beautiful results that last.`,image:"/Services Stock images/Painting contracting.png",category:"Painting",author:"Fatima Ali",date:"2025-10-25",readTime:"13 min read"},{id:7,slug:"energy-efficient-home-upgrades",title:"Energy-Efficient Home Upgrades That Pay Off",excerpt:"Reduce your electricity bills and carbon footprint with these smart home improvements.",content:`UAE residents face some of the highest electricity consumption rates globally, with air conditioning alone accounting for 60-70% of residential energy use. However, strategic home upgrades can dramatically reduce consumption, lower bills, and increase property value while supporting UAE's sustainability goals. Here's your guide to energy-efficient improvements that deliver real returns.
...
• Reflective roof coatings reduce surface temperature by 10-15\xb0C
...
• Set AC to 24-25\xb0C instead of 20-21\xb0C (save 8% per degree)
...
Contact Aqsa Tech for a free energy efficiency consultation. Let's create your customized upgrade plan and start reducing your bills while building a more sustainable future.`,image:"/Services Stock images/Air-coditioning installation.png",category:"Energy Efficiency",author:"Aqsa Tech Team",date:"2025-10-20",readTime:"15 min read"}];e.s(["blogPosts",0,r],36468);let s={EN:{categories:["All","Company","Home Maintenance","HVAC","Renovation","Plumbing","Painting","Energy Efficiency"],posts:[{id:1,slug:"elevating-spaces-with-excellence-aqsatech",title:"Elevating Spaces with Excellence – AQSATECH Contracting & Maintenance Services",excerpt:"At AQSATECH, we believe that every space has the potential to inspire comfort, functionality, and elegance. Discover our comprehensive range of services.",category:"Company"},{id:2,slug:"top-10-home-maintenance-tips-dubai",title:"Top 10 Home Maintenance Tips for Dubai Residents",excerpt:"Keep your Dubai home in perfect condition year-round with these essential maintenance tips from our expert team.",category:"Home Maintenance"},{id:3,slug:"ac-maintenance-summer-guide",title:"AC Maintenance: Your Complete Summer Guide",excerpt:"Beat the Dubai heat with our comprehensive AC maintenance checklist and professional tips.",category:"HVAC"},{id:4,slug:"kitchen-renovation-trends-2025",title:"Kitchen Renovation Trends 2025: What's Hot in Dubai",excerpt:"Discover the latest kitchen design trends transforming Dubai homes this year.",category:"Renovation"},{id:5,slug:"plumbing-emergencies-what-to-do",title:"Plumbing Emergencies: What to Do Before Help Arrives",excerpt:"Quick action can prevent water damage. Learn the essential first steps for common plumbing emergencies.",category:"Plumbing"},{id:6,slug:"choosing-right-paint-dubai-climate",title:"Choosing the Right Paint for Dubai's Climate",excerpt:"Not all paints are created equal. Find out which finishes and formulas work best in the UAE.",category:"Painting"},{id:7,slug:"energy-efficient-home-upgrades",title:"Energy-Efficient Home Upgrades That Pay Off",excerpt:"Reduce your electricity bills and carbon footprint with these smart home improvements.",category:"Energy Efficiency"}]}};var o=e.i(11110);e.s(["useTranslatedBlogPosts",0,()=>{let{language:e}=(0,o.useLanguage)();return{translatedPosts:(0,n.useMemo)(()=>r,[]),translatedCategories:(0,n.useMemo)(()=>s[e].categories,[e])}}],45574)},94846,e=>{"use strict";var t=e.i(43476),a=e.i(71645),i=e.i(18566),n=e.i(46932),r=e.i(71689),s=e.i(87316),o=e.i(3116),l=e.i(84614),c=e.i(7089),d=e.i(11110),m=e.i(45574),u=e.i(19418);let p={hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.1}}},g={hidden:{opacity:0,y:30,scale:.95},visible:{opacity:1,y:0,scale:1,transition:{duration:.2,ease:[.25,.1,.25,1]}}};function h(){let{t:e,isRTL:h}=(0,d.useLanguage)(),f=(0,i.useRouter)(),y=e=>{"number"==typeof e&&-1===e?f.back():"string"==typeof e&&f.push(e)},{translatedPosts:v,translatedCategories:b}=(0,m.useTranslatedBlogPosts)(),w=b[0],[x,A]=(0,a.useState)(w);(0,a.useEffect)(()=>{requestAnimationFrame(()=>{window.scrollTo({top:0,behavior:"smooth"})})},[]),(0,a.useEffect)(()=>{A(b[0])},[b]);let k=(0,a.useMemo)(()=>x===w?v:v.filter(e=>e.category===x),[x,w,v]);return(0,t.jsxs)("div",{className:"min-h-screen bg-soft-gray-light pt-20 sm:pt-24 overflow-x-hidden",children:[(0,t.jsx)("section",{className:"bg-white border-b border-gray-200 overflow-x-hidden",children:(0,t.jsxs)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12 w-full overflow-x-hidden",children:[(0,t.jsxs)(n.motion.button,{onClick:()=>y(-1),className:`flex items-center gap-2 text-gray-600 hover:text-gray-900 mb-4 sm:mb-6 transition-colors text-sm sm:text-base ${h?"flex-row-reverse ml-auto":""}`,whileHover:{x:h?4:-4},whileTap:{scale:.95},children:[(0,t.jsx)(r.ArrowLeft,{className:`w-4 h-4 sm:w-5 sm:h-5 ${h?"rotate-180":""}`}),(0,t.jsx)("span",{className:"font-medium",children:e("common.back")})]}),(0,t.jsxs)(n.motion.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.2,ease:[.25,.1,.25,1]},className:"text-center sm:text-left",children:[(0,t.jsx)("h1",{className:`text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-2 sm:mb-3 lg:mb-4 ${h?"sm:text-right":""}`,children:e("blog.title")}),(0,t.jsx)("p",{className:`text-sm sm:text-base lg:text-lg xl:text-xl text-gray-900 max-w-3xl mx-auto sm:mx-0 mb-4 sm:mb-6 font-medium ${h?"sm:text-right":""}`,children:e("blog.subtitle")}),(0,t.jsx)("div",{className:`flex gap-2 sm:gap-3 lg:gap-4 overflow-x-auto pb-2 scrollbar-hide mt-4 sm:mt-6 lg:mt-8 w-full ${h?"flex-row-reverse justify-start sm:justify-start":"justify-start sm:justify-start"}`,children:b.map(e=>(0,t.jsx)("button",{onClick:()=>A(e),className:`px-4 sm:px-5 lg:px-7 py-2 sm:py-2.5 lg:py-3.5 rounded-lg sm:rounded-xl text-xs sm:text-sm lg:text-base font-bold whitespace-nowrap transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 active:scale-95 flex-shrink-0 ${x===e?"bg-gray-900 text-white shadow-xl scale-105 ring-2 ring-gray-700":"bg-white text-gray-900 hover:bg-gray-50 border-2 border-gray-300 hover:border-gray-500"}`,children:e},e))})]})]})}),(0,t.jsxs)("section",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 lg:py-16 w-full overflow-x-hidden",children:[(0,t.jsx)(n.motion.div,{variants:p,initial:"hidden",animate:"visible",className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-8 w-full items-stretch",children:k.map(a=>(0,t.jsxs)(n.motion.article,{variants:g,whileHover:{y:-8,transition:{duration:.3}},className:"bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 group flex flex-col h-full",children:[(0,t.jsxs)("div",{className:"relative h-48 sm:h-56 lg:h-64 overflow-hidden flex-shrink-0",children:[(0,t.jsx)("img",{src:a.image,alt:a.title,loading:"lazy",decoding:"async",width:800,height:450,sizes:"(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw",className:"w-full h-full object-cover transition-transform duration-500 group-hover:scale-110",style:{contentVisibility:"auto"}}),(0,t.jsx)("div",{className:"absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent"}),(0,t.jsx)("span",{className:`absolute top-4 ${h?"right-4":"left-4"} bg-white/90 backdrop-blur-sm text-gray-800 px-3 py-1 rounded-full text-xs font-medium`,children:a.category})]}),(0,t.jsxs)("div",{className:"p-4 sm:p-5 lg:p-6 flex flex-col flex-grow",children:[(0,t.jsx)("h2",{className:`text-sm sm:text-base lg:text-lg xl:text-xl 2xl:text-2xl font-bold text-gray-900 mb-2 sm:mb-3 group-hover:text-brand-teal transition-colors line-clamp-2 ${h?"text-right":"text-left"}`,children:a.title}),(0,t.jsx)("p",{className:`text-gray-900 text-xs sm:text-sm lg:text-base leading-relaxed mb-3 sm:mb-4 line-clamp-3 flex-grow ${h?"text-right":"text-left"}`,children:a.excerpt}),(0,t.jsxs)("div",{className:"flex flex-wrap items-center gap-2 sm:gap-3 text-xs sm:text-sm text-gray-700 mb-3 sm:mb-4",children:[(0,t.jsxs)("span",{className:"flex items-center gap-1",children:[(0,t.jsx)(s.Calendar,{size:14}),new Date(a.date).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})]}),(0,t.jsxs)("span",{className:"flex items-center gap-1",children:[(0,t.jsx)(o.Clock,{size:14}),a.readTime]}),(0,t.jsxs)("span",{className:`flex items-center gap-1 ${h?"flex-row-reverse":""}`,children:[(0,t.jsx)(l.User,{size:14}),a.author]})]}),(0,t.jsx)(c.default,{onClick:()=>y(`/blog/${a.slug}`),variant:"dark",size:"md",fullWidth:!0,children:e("blog.readMore")})]})]},a.id))}),0===k.length&&(0,t.jsx)("div",{className:`text-center py-16 ${h?"text-right":"text-left"}`,children:(0,t.jsx)("p",{className:"text-gray-900 text-lg font-medium",children:e("blog.noArticles")})})]}),(0,t.jsx)("section",{className:"bg-brand-gradient text-white py-10 sm:py-14 lg:py-20",children:(0,t.jsx)("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full",children:(0,t.jsxs)(n.motion.div,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.2,ease:[.25,.1,.25,1]},children:[(0,t.jsx)("h2",{className:"text-2xl sm:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 px-2 sm:px-0 text-white",children:e("blog.needProfessionalHelp")}),(0,t.jsx)("p",{className:"text-sm sm:text-base lg:text-lg text-white mb-6 sm:mb-8 px-2 sm:px-0 font-medium",children:e("blog.professionalHelpDescription")}),(0,t.jsxs)("div",{className:"flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-2 sm:px-0",children:[(0,t.jsx)(c.default,{as:"a",href:(0,u.generateWhatsAppUrl)(u.WHATSAPP_PHONE,e("whatsapp.blogQuote")),target:"_blank",rel:"noopener noreferrer","aria-label":"Get Free Quote on WhatsApp",variant:"dark",size:"lg",className:"w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base",children:e("hero.getFreeQuote")}),(0,t.jsx)(c.default,{as:"a",href:"tel:+971525010132",variant:"outline",size:"lg",className:"w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 border-white text-white hover:bg-white hover:text-gray-900 text-sm sm:text-base",children:e("hero.callNow")})]})]})})})]})}function f(){return(0,t.jsx)(a.Suspense,{fallback:(0,t.jsx)("div",{className:"min-h-screen"}),children:(0,t.jsx)(h,{})})}e.s(["default",()=>f],94846)}]);