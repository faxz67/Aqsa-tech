module.exports=[36076,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/src/app/blog/[slug]/ClientPage.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/src/app/blog/[slug]/ClientPage.tsx <module evaluation>","default")},21228,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/src/app/blog/[slug]/ClientPage.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/src/app/blog/[slug]/ClientPage.tsx","default")},51269,a=>{"use strict";a.i(36076);var b=a.i(21228);a.n(b)},67932,a=>{"use strict";var b=a.i(7997);let c=[{id:1,slug:"elevating-spaces-with-excellence-aqsatech",title:"Elevating Spaces with Excellence – AQSATECH Contracting & Maintenance Services",excerpt:"At AQSATECH, we believe that every space has the potential to inspire comfort, functionality, and elegance. Discover our comprehensive range of services.",content:`At AQSATECH, we believe that every space has the potential to inspire comfort, functionality, and elegance. With years of experience in the contracting and maintenance industry, we have built a reputation for delivering high-quality solutions tailored to our clients' needs. From stylish interiors to reliable technical installations, our expertise covers a wide spectrum of services that make us a one-stop solution for both residential and commercial projects.
...
Contact Aqsa Tech for a free energy efficiency consultation. Let's create your customized upgrade plan and start reducing your bills while building a more sustainable future.`,image:"/Services Stock images/Air-coditioning installation.png",category:"Energy Efficiency",author:"Aqsa Tech Team",date:"2025-10-20",readTime:"15 min read"}];var d=a.i(51269);async function e({params:a}){let b=await a,d=c.find(a=>a.slug===b.slug);return d?{title:`${d.title} | Aqsa Tech UAE`,description:d.excerpt,openGraph:{title:`${d.title} | Aqsa Tech UAE`,description:d.excerpt,images:[d.image]},alternates:{canonical:`/blog/${d.slug}`}}:{title:"Post Not Found | Aqsa Tech UAE"}}async function f(){return c.map(a=>({slug:a.slug}))}function g(){return(0,b.jsx)(d.default,{})}a.s(["default",()=>g,"generateMetadata",()=>e,"generateStaticParams",()=>f],67932)}];

//# sourceMappingURL=src_app_blog_%5Bslug%5D_69371787._.js.map